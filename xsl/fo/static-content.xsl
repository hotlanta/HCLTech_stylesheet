            ...
            <fo:table-body>
               <fo:table-row>
                  ...
                  <fo:table-cell xsl:use-attribute-sets="__footer__logo">
                     <fo:block>
                        <fo:external-graphic
                           src="url(Customization/OpenTopic/common/artwork/HCLTechLogo.svg)" content-width="scale-to-fit" content-height="scale-to-fit" width="50pt" height="50pt" scaling="uniform">
                        </fo:external-graphic>
                     </fo:block>
                  </fo:table-cell>
               </fo:table-row>
